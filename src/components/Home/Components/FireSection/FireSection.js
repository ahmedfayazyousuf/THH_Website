    ...
    return (
        <div style={{height: '100%', width: '100vw', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{height: '100%', width: '100vw', backgroundColor: 'black', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                ...
                <div style={{height:'100%', width:  window.innerWidth>= 750 ?  '50%':"100%", border: '0.5px solid transparent', display: 'flex', flexDirection: 'column',zIndex:'100000000000',flex:'50%'}}>
                ...
                <div id='DesktView' style={{height:'100%',width:'20%', display: window.innerWidth<= 750 ? 'none' : 'flex', justifyContent: 'center', alignItems: 'center',zIndex:0,flex:'50%'}}>
                    <TextAnim  Body={
